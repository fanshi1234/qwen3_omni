...
echo "输出目录: ./train/output_stage_a_cls"
echo "=========================================="
...
python train/train.py \
    ...
    --output_dir ./train/output_stage_a_cls \
    ...
    2>&1 | tee ./train/output_stage_a_cls/train.log

echo ""
echo "✅ 阶段 A (类别权重) 训练完成"
echo "📁 模型: ./train/output_stage_a_cls/"
echo "📊 日志: ./train/output_stage_a_cls/train.log"
